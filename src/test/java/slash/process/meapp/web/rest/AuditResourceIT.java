...
import slash.process.meapp.config.ReactivePageableHandlerMethodArgumentResolver;
import slash.process.meapp.config.TestSecurityConfiguration;
import io.github.jhipster.config.JHipsterProperties;
import slash.process.meapp.config.audit.AuditEventConverter;
import slash.process.meapp.domain.PersistentAuditEvent;
import slash.process.meapp.repository.PersistenceAuditEventRepository;
