...
import slash.process.meapp.config.Constants;
import slash.process.meapp.domain.Authority;
import slash.process.meapp.domain.User;
import slash.process.meapp.repository.AuthorityRepository;
import slash.process.meapp.repository.UserRepository;
import slash.process.meapp.security.AuthoritiesConstants;
import slash.process.meapp.service.UserService;
import slash.process.meapp.service.dto.PasswordChangeDTO;
import slash.process.meapp.service.dto.UserDTO;
import slash.process.meapp.web.rest.vm.KeyAndPasswordVM;
import slash.process.meapp.web.rest.vm.ManagedUserVM;
...
import static slash.process.meapp.web.rest.AccountResourceIT.TEST_USER_LOGIN;
