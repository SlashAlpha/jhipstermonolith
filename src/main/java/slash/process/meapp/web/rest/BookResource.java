...
import slash.process.meapp.domain.Book;
import slash.process.meapp.repository.BookRepository;
...
/**
 * REST controller for managing {@link slash.process.meapp.domain.Book}.
 */
@RestController
@RequestMapping("/api")
@Transactional
