...
import slash.process.meapp.repository.CustomReactiveN1qlCouchbaseRepository;
...
@EnableReactiveCouchbaseRepositories(repositoryBaseClass = CustomReactiveN1qlCouchbaseRepository.class, basePackages = "slash.process.meapp.repository")
