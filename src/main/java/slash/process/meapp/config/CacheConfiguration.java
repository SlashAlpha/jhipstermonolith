...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, slash.process.meapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, slash.process.meapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
